<div style="margin: 15px;">
	<form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <#elseif item.status = -1>
                    <input type="text" style="color: blue" disabled="disabled" class="layui-input" value="订单错误" }">
				<#elseif item.status = 1>
                ...
                <#elseif item.status = 5>
                    <input type="text" style="color: green" disabled="disabled" class="layui-input" value="支付成功-奖励成功" }">
                <#elseif item.status = 6>
                    <input type="text" style="color: green" disabled="disabled" class="layui-input" value="处理完成-奖励成功" }">
				<#else>
				</#if>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" disabled="disabled" class="layui-input" value="${item.channelAccount!"" }">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea disabled="disabled" class="layui-textarea">${item.param1!"" }</textarea>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">参数2</label>
            <div class="layui-input-block">
                <textarea disabled="disabled" class="layui-textarea">${item.param2!"" }</textarea>
            </div>
        </div>
        <div class="layui-form-item">
