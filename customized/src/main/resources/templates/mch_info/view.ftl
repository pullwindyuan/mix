<div style="margin: 15px;">
	<form class="layui-form">
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-block">
			<#if item.type = "0">
                <input type="text" disabled="disabled" class="layui-input" value="平台">
			<#elseif item.type = "1">
				<input type="text" disabled="disabled" class="layui-input" value="商户">
			<#elseif item.type = "2">
				<input type="text" disabled="disabled" class="layui-input" value="商户分支机构">
			<#else>
			</#if>
            </div>
		</div>
