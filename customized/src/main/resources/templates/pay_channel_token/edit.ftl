<div style="margin: 15px;">
	<form class="layui-form">
		...
		<div class="layui-form-item">
			<label class="layui-form-label">通证名称</label>
			<div class="layui-input-block">
				<select name="tokenName" lay-verify="required">
					<option value=""></option>
					<option value="bd" <#if (item.tokenName!"") == "bd">selected="selected"</#if>>比豆</option>
					<option value="htl" <#if (item.tokenName!"") == "htl">selected="selected"</#if>>HTL</option>
					<option value="eth" <#if (item.tokenName!"") == "eth">selected="selected"</#if>>ETH</option>
					<option value="gusd" <#if (item.tokenName!"") == "gusd">selected="selected"</#if>>GUSD</option>
				</select>
			</div>
		</div>
		<div class="layui-form-item">
