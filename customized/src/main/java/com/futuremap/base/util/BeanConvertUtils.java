 ...
 public class BeanConvertUtils {
   ...
   public static Map<String, ? extends Object> bean2Map(Object obj) {
     try {
       Map<String, ? extends Object> map = BeanUtils.describe(obj);
       map.remove("class");
       return map;
   ...
   public static Map<String, Object> bean2MapWithOutNull(Object obj) {
     try {
       ...
       Iterator<Map.Entry<String, ? extends Object>> iterator = (Iterator<Map.Entry<String, ? extends Object>>) entrySet.iterator();

       Map<String, Object> newMap = new HashMap<>();
       while (iterator.hasNext()) {
         Map.Entry<String, ? extends Object> temp = iterator.next();
   ...
   public static <T> T map2BeanCommon(Map<String, ? extends Object> map, Class<T> clazz) {
     if (map == null || clazz == null) {
       return null;
     }
     T bean = null;
