 ...
 public class UnionIdUtil
 {
   ...
   public static String[] getIdsFromUnionId(String inputId) {
     if (StringUtils.isBlank(inputId)) {
       return null;
     }
   ...
   public static String[] getIdsFromUnionId(String inputId, String separator) {
     if (StringUtils.isBlank(inputId)) {
       return null;
     }
     return inputId.split(separator);
   }
