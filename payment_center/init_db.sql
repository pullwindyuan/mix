CREATE DATABASE pay_center DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
Use pay_center;
/*
 Navicat Premium Data Transfer

 Source Server         : pay_center
...
CREATE TABLE `t_pay_channel` (
  ...
  `MchId` varchar(30) NOT NULL COMMENT '商户ID',
  `ChannelAccount` varchar(128) DEFAULT NULL COMMENT '渠道收款账号',
...
CREATE TABLE `t_pay_order` (
  `PayOrderId` varchar(64) NOT NULL COMMENT '支付订单号',
  `MchId` varchar(30) NOT NULL COMMENT '商户ID',
  `MchOrderNo` varchar(64) NOT NULL COMMENT '商户订单号',
  `ChannelId` varchar(24) NOT NULL COMMENT '渠道ID',
  `ChannelAccount` varchar(128) NOT NULL COMMENT '渠道收款账号',
  ...
  `Extra` varchar(1024) DEFAULT NULL COMMENT '特定渠道发起时额外参数',
  `ChannelMchId` varchar(32) NOT NULL COMMENT '渠道商户ID',
  ...
  `Param1` varchar(1000) DEFAULT NULL COMMENT '扩展参数1',
  `Param2` varchar(1000) DEFAULT NULL COMMENT '扩展参数2',
...
CREATE TABLE `t_trans_order` (
  `TransOrderId` varchar(64) NOT NULL COMMENT '转账订单号',
  `MchId` varchar(30) NOT NULL COMMENT '商户ID',
  `MchTransNo` varchar(64) NOT NULL COMMENT '商户转账单号',
  `ChannelId` varchar(24) NOT NULL COMMENT '渠道ID',
  ...
  `ChannelUser` varchar(64) DEFAULT NULL COMMENT '渠道用户标识,如微信openId,支付宝账号',
  `UserName` varchar(64) DEFAULT NULL COMMENT '用户姓名',
  `ChannelMchId` varchar(64) NOT NULL COMMENT '渠道商户ID',
  `ChannelOrderNo` varchar(64) DEFAULT NULL COMMENT '渠道订单号',
...
CREATE TABLE `t_refund_order` (
  `RefundOrderId` varchar(64) NOT NULL COMMENT '退款订单号',
  `PayOrderId` varchar(64) NOT NULL COMMENT '支付订单号',
  `ChannelPayOrderNo` varchar(64) DEFAULT NULL COMMENT '渠道支付单号',
  `MchId` varchar(30) NOT NULL COMMENT '商户ID',
  `MchRefundNo` varchar(64) NOT NULL COMMENT '商户退款单号',
  `ChannelId` varchar(24) NOT NULL COMMENT '渠道ID',
