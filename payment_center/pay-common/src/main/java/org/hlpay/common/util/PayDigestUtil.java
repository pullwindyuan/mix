 ...
 public class PayDigestUtil
 {
   ...
   public static String getSign(Object o, String key) throws IllegalAccessException {
     ...
     _log.debug("Sign Before MD5:" + result, new Object[0]);
     result = md5(result, encodingCharset).toUpperCase();
     _log.debug("Sign Result:" + result, new Object[0]);
     return result;
   }
   ...
   public static String getSign(Map<String, Object> map, String key, String... notContains) {
     ...
     for (Map.Entry<String, Object> entry : map.entrySet()) {
       ...
       for (int i = 0; i < notContains.length; i++) {
         if (("".equals(entry.getValue()) && null == entry.getValue()) || ((String)entry.getKey()).equals(notContains[i])) {
           isContain = true;
           break;
         }
       }
   ...
   public static void main(String[] args) {
     ...
     String dataStr = "AnnulCard1000043252120080620160450.0http://localhost.com/SZXpro/callback.asp这4564868265473632445648682654736324511";
