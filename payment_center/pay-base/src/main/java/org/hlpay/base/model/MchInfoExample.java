   ...
   implements Serializable
 {
   ...
   private Integer limit; private Integer offset;
     ...
     implements Serializable
   {
     ...
     public Criteria andMchIdStartWith(String value) {
       addCriterion("MchId like", value + "%", "mchId");
       return (Criteria)this;
     }
     ...
     public Criteria andParentMchIdEqualTo(String value) {
       addCriterion("ParentMchId =", value, "parentMchId");
       return (Criteria)this;
     }
     ...
     public Criteria andParentExternalIdEqualTo(String value) {
       addCriterion("ParentExternalId =", value, "parentExternalId");
       return (Criteria)this;
     }
   ...
   public int hashCode() {
     int prime = 31;
     int result = 1;
     result = 31 * result + ((getOredCriteria() == null) ? 0 : JSONArray.toJSONString(getOredCriteria()).hashCode());
     return result;
   }
 }
