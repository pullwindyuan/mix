   ...
   extends ProMchInfoVo
 {
   ...
   @ApiModelProperty(value = "请求参数签名key", required = true)
   private String reqKey;
   @ApiModelProperty(value = "返回信息签名key", required = true)
   private String resKey;
   @ApiModelProperty("商户对应的支付渠道信息")
   private List<PayChannelForAppVo> payChannels;
   ...
   public List<PayChannelForAppVo> getPayChannels() {
     return this.payChannels;
   }

   public void setPayChannels(List<PayChannelForAppVo> payChannels) {
...
/* Location:              D:\jar\pay-base.jar!\org\hlpay\base\vo\MchInfoForAppVo.class
