 ...
 public class MchInfoForConfigBo extends ProMchInfoBo { @ApiModelProperty("商户ID")
   ...
   private String type; private String reqKey;
   public void setSettleParams(String settleParams) { this.settleParams = settleParams; }
   ...
   private List<PayChannelForConfigBo> payChannels;
   @ApiModelProperty("平台代理信息，隶属于平台")
   private BaseMchInfoBo agency; private
   String settleParams;
   @ApiModelProperty("商户类型（pc：支付渠道参数； mch：商户信息）")
   ...
   public BaseMchInfoBo getAgency() {
     return this.agency;
   }

   public void setAgency(BaseMchInfoBo agency) {
     this.agency = agency;
   }
   ...
   public List<PayChannelForConfigBo> getPayChannels() {
   ...
   public void setPayChannels(List<PayChannelForConfigBo> payChannels) {
