...
<footer class="footer">
    <div class="container">
        <p class="text-muted">2018&copy; 物连家美网络科技有限公司 <script src="https://s13.cnzz.com/z_stat.php?id=1262480096&web_id=1262480096" language="JavaScript"></script></p>
    </div>
</footer>
...
<script>
    ...
    function makeCode () {
        ...
        $("#vAmt").text(vAmt+'元');
        //var qrText = 'http://pay-shop.ngrok.cc/goods/qrPay/' + (vAmt*100);
        //var qrText = 'http://pay.bibi321.com/qrPay.html?amount=' + (vAmt*100);
        var qrText = 'http://shop.bibi321.com/qrPay.html?amount=' + (vAmt*100) + '&redirect=http://m.bibi321.com';
