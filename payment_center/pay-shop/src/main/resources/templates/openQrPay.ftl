...
<footer class="footer">
    <div class="container">
        <p class="text-muted">2018&copy; 深圳航旅投资发展有限公司 <script src="https://s13.cnzz.com/z_stat.php?id=1262480096&web_id=1262480096" language="JavaScript"></script></p>
    </div>
</footer>
...
<script>
    ...
    function makeCode () {
        ...
        var qrText = 'http://pay.bibi321.com/qrPay.html?amount=' + (vAmt*100) + '&redirect=http://m.bibi321.com';
