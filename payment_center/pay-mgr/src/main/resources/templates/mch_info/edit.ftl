		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<select name="type" lay-verify="required">
					<option value=""></option>
                    <option value="0" <#if (item.type!"") == "1">selected="selected"</#if>>平台</option>
                    <option value="1" <#if (item.type!"") == "2">selected="selected"</#if>>商户</option>
					<option value="2" <#if (item.type!"") == "3">selected="selected"</#if>>商户分支机构</option>
				</select>
			</div>
		</div>
		<div class="layui-form-item">
